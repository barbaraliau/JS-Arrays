...
//then loop through the array to see if that random number is in the array. If it is, return true, if it's not, return false
  ...
  var finder = function(array) { 
    // assign the random number generated by getRandomArbitrary function to variable
...
//Write a function called reverse that takes is given str as it's only argument and returns that string after it's been reversed
  ...
  var reverse = function (string) {
    // return string after: string is made into array with each element split every character, reverse that array, join every character
